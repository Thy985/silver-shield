...
| [0027](0027-audio-memory-integration.md) | 音频记忆集成：音频经统一决策门（DecisionPolicy）汇入 Memory，不新增写入链；D1 modalities 多模态标记 + D2 统一 EvidenceItem 废弃双 EvidenceRef + D4 AudioSessionId 不强绑 visitor + D5 CrossModalLink 关系/边 + D6 Consumer audio-aware（仅标签不分数）+ D8 Schema Evolution 向后兼容（承接 ADR-0024/0025/0026/0022，守 ADR-0001/0002） | Proposed (review-ready) | 2026-08-06 |
